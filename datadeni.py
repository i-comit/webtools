...
class Page1(Page):
    def __init__(self, *args, **kwargs):
        ...
        drivers = StringVar(self)

        OM0 = tk.OptionMenu(self, drivers,*driveArrayList)
        ...
        num1 = Button(self, fg="white", text ="1", bg = "#3F3F3F", command=lambda:setPin("1"))
        num1.config(height = 2, width = 5)
        num1.place(relx=.04, rely = .02)

        num2 = Button(self, fg="white", text = "2", bg = "#3F3F3F", command=lambda:setPin("2"))
        num2.config(height = 2, width = 5)
        num2.place(relx=.04, rely = .22)

        num3 = Button(self, fg="white", text ="3", bg = "#3F3F3F", command=lambda:setPin("3"))
        num3.config(height = 2, width = 5)
        num3.place(relx=.04, rely = .42)

        num4 = Button(self, fg="white", text = "4", bg = "#3F3F3F", command=lambda:setPin("4"))
        num4.config(height = 2, width = 5)
        num4.place(relx=.04, rely = .62)

        num5 = Button(self, fg="white", text ="5", bg = "#3F3F3F", command=lambda:setPin("5"))
        num5.config(height = 2, width = 5)
        num5.place(relx=.04, rely = .82)

        num6 = Button(self, fg="white", text ="6", bg = "#3F3F3F", command=lambda:setPin("6"))
        num6.config(height = 2, width = 5)
        num6.place(relx=.22, rely = .02)

        num7 = Button(self, fg="white", text = "7", bg = "#3F3F3F", command=lambda:setPin("7"))
        num7.config(height = 2, width = 5)
        num7.place(relx=.22, rely = .22)

        num8 = Button(self, fg="white", text ="8", bg = "#3F3F3F", command=lambda:setPin("8"))
        num8.config(height = 2, width = 5)
        num8.place(relx=.22, rely = .42)

        num9 = Button(self, fg="white", text = "9", bg = "#3F3F3F", command=lambda:setPin("9"))
        num9.config(height = 2, width = 5)
        num9.place(relx=.22, rely = .62)

        num0 = Button(self, fg="white", text ="0", bg = "#3F3F3F", command=lambda:setPin("0"))
        ...
        Chk1 = tk.Button(self,bg='#3F3F3F', fg='#37D028',padx=10, pady=5, borderwidth=3, relief="ridge", command=lambda:[hideFolder(),ButtonChk(1)])
